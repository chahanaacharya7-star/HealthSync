<footer class="footer">
    <div class="footer-content">
        <div class="footer-brand">
            ...
            <p>Your trusted health management partner, delivering state-of-the-art medical services directly to your fingertips.</p>
        </div>
    ...
    <div class="footer-bottom">
        <p>&copy; 2026 HealthSync. All rights reserved. Designed for optimal healthcare.</p>
    </div>
</footer>
